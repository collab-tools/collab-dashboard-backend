...
}, function (req, usernameOrEmail, password, callback) {
...
/***************************************************************
  ...
  ***************************************************************/
passport.use('jwt-auth', new JwtStrategy(jwtStrategyOptions, function (jwt_payload, done_callback) {
  var user = {
...
exports.login = function (req, res, next) {
  ...
  var token = jwt.sign(strippedUser, config.jwtSecret, { expiresIn: config.jwtExpiresInSeconds });
  res.send({
    username: user.username,
    sessionToken: token
  });
